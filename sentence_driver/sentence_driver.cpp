...
COURSE:  COP 3530								DUE DATE:  10/10/2021
Assignment Name:  Assignment#4                 Professor:  Dr. Petrie
Description:  This prgram includes the following: lists of singly-linked list, strings, classes, pointers, 
friend function, overload <<, overload =, remove, add to back, and more.  
******************************************************************************************************/
